...
@NamedQueries({
    ...
    @NamedQuery(name = "Empleado.findByParameters", query = "SELECT e FROM Empleado e WHERE e.cedula LIKE :cedula AND lower(e.nombre) LIKE :nombre AND lower(e.primerApellido) LIKE :primerApellido AND lower(e.segundoApellido) LIKE :segundoApellido"),
...
public class Empleado implements Serializable {
   ...
   // @Temporal(TemporalType.TIMESTAMP)
    ...
    public Empleado(Long empId, String empNombre, String empPapellido, String empSapellido, String empCedula, String empGenero, String empAdministrador, LocalDate empFingreso, String empEstado, Long empVersion) {
        this.id = empId;
    ...
    public void actualizar(EmpleadoDto empleadoDto) {
        ...
        this.fechaIngreso = empleadoDto.getIngreso();
        this.fechaSalida = empleadoDto.getEmpFsalida();
